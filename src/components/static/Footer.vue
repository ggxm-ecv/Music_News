<template>
  <footer class="border-t-2 border-white p-6 grid flex flex-col justify-center items-center">
    <div class="flex justify-center">
      <router-link to="/" class="footer__title inline-block bg-indigo-900 px-4 py-2 rounded-lg"> 

<template>
  <header class="z-10 relative sticky top-0 shadow-md bg-gray-800 px-4 py-2 lg:p-6 flex lg:grid grid-cols-none lg:grid-cols-3 lg:justify-between items-center">
    <div class="mobile-only">
      <div @click="toggleActiveMobileMenu" class="header__burger-menu inline-block bg-gray-900 px-2 py-1 rounded-lg">
    ...
    <div class="ml-4 lg:ml-0">
      <router-link to="/" class="header__title inline-block bg-gray-900 px-4 py-2 rounded-lg"> 
    ...
    <p class="ml-4 lg:ml-0 text-center desktop-only">Bienvenue dans la partie administration !</p>

    <nav class="header__main-nav mobile-only absolute lg:relative top-0 left-0 lg:top-auto z-20 flex justify-center items-center bg-gray-800 w-full lg:w-auto h-screen lg:h-auto" :class="{active: mobileNavIsActive}">
      <div @click="toggleActiveMobileMenu" class="header__main-nav-close mobile-only absolute top-4 right-4 inline-block bg-gray-900 px-2 py-1 rounded-lg">

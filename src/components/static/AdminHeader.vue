<template>
  <header class="sticky top-0 shadow-md bg-gray-800 p-6 grid grid-cols-3 justify-between items-center">
    <div>
    ...
    <p class="text-center">Bienvenue dans la partie administration !</p>
